...
import CreateReferral from '@/components/ModalComponent/CreateReferral/CreateReferral';
import WithdrawalPay from '@/components/ModalComponent/WithdrawalPay/WithdrawalPay';
